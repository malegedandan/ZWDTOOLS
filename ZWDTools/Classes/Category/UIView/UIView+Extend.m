...
/// 添加阴影
/// @param offset 阴影方向
- (void)setViewShadow:(CGSize)offset{
    self.layer.shadowColor =  [KBlackColor colorWithAlphaComponent:0.03].CGColor;
...
- (void)setViewRoundedRect:(CGRect)rect corners:(UIRectCorner)corner cornerRadius:(CGSize)cornerRadius{
    UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:rect byRoundingCorners:corner cornerRadii:cornerRadius];
